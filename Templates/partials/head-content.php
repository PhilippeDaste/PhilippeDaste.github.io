...
<link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+JP:wght@300&Dosis:wght@300&family=IBM+Plex+Sans+JP:wght@300&family=Piazzolla:wght@300display=swap" rel="stylesheet">